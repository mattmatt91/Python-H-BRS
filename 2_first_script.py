...
#  atupcomplete console: tab
# python + filename
# python first_script.py
# immer darauf achten, dass man im richtigen Ordner ist 
...
# basically you can always google errors, preferably without any absolute paths
# github --> always look for green tick